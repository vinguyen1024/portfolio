...
const About = () => (
    <>
        ...
        <p>When I'm not on the computer coding, I like to spend my time with creative hobbies like crafting, being a bedroom DJ, learning piano and music production, and cooking. I also love going to music festivals, playing video games like Final Fantasy or Kingdom Hearts, and hanging out with my dog.</p>
    </>
);
